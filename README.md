## Loopless
A minimal PHP framework for developing front-end web applications.

Loopless main scope is to be an API addicted and stay wired to your whatever backend apps (one or more).


### Roadmap
...

### Projects made with Loopless
...
Originally made for a private luxury villas company. The main task was to give to non technical people the chance to run Mailchimp campaigns without touching the code.
